package com.allumez.refercanada.com.allumez.refercanada.canadianListing;
...
import com.allumez.refercanada.com.allumez.refercanada.jsonData.JsonHolder_State_Listing;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            {
                                loading.dismiss();
                                Toast.makeText(Canadian_Cities_Activity.this, "Work in Progress....", Toast.LENGTH_SHORT).show();
                            }
                            else if (abc == 1)
                            {
                                loading.dismiss();
...
//
                                        Intent intent = new Intent(Canadian_Cities_Activity.this, Canadian_Cities_Category_Activity.class);
                                        ...
                                        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                                            ...
                                            public boolean onQueryTextSubmit(String query) {
                                                if(list.contains(query)){
                                                    ...
                                                    Toast.makeText(Canadian_Cities_Activity.this, "No Match found",Toast.LENGTH_LONG).show();
                                                }
                                                return false;
                                            }
                                            @Override

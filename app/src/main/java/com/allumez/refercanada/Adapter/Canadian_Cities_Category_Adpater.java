...
public class Canadian_Cities_Category_Adpater extends BaseAdapter implements Filterable {
    ...
    public List<Setting_Category_Data> filteredData;
    protected Context c;
    protected Canadian_Cities_Category_Adpater.ItemFilter mFilter = new Canadian_Cities_Category_Adpater.ItemFilter();
    protected List<Setting_Category_Data> list;

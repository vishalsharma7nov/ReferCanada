...
public class Coupons extends AppCompatActivity {
    ...
    List<SettingCouponsCategoryData> settingDataList;
    String url;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            else if (abc == 1)
                            {
                                loading.dismiss();
                                showJSON(response);
                                final String[] mId = JsonHolderCouponsCategory.id;
    ...
    private void showJSON(String json) {
        JsonHolderCouponsCategory jsonHolderCouponsCategory= new JsonHolderCouponsCategory(json);

...
public class SettingCouponsDetailsData {
    ...
    public SettingCouponsDetailsData(String id, String title, String description, String image, String category_id, String business_listing_id, String actual_price, String discounted_price, String total_number_of_coupons, String created_at) {
        this.id = id;
        this.title = title;

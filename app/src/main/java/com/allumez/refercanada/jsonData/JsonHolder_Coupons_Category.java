...
public class JsonHolder_Coupons_Category {
    ...
    private String json;
    public JsonHolder_Coupons_Category(String json) {
        this.json = json;
    }
    public List<Setting_Coupons_Category_Data> parseJSON(){
        JSONObject jsonObject = null;
        List<Setting_Coupons_Category_Data> list = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < users.length(); i++) {
                ...
                Setting_Coupons_Category_Data sd = new Setting_Coupons_Category_Data(jo.getString(KEY_ID), jo.getString(KEY_CITYNAME),jo.getString(KEY_CITY_COUPON_ICON));
                list.add(sd);
